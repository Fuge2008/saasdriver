...
public class HorizontalStepsViewIndicator extends View{
    ...
    private int mUnCompletedLineColor = ContextCompat.getColor(getContext(), R.color.uncompleted_flag);//定义默认未完成线的颜色  definition
    ...
    private void init()
    {
        mStepBeanList = new ArrayList<StepBean>();
        mPath = new Path();
