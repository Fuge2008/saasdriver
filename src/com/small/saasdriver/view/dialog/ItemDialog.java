...
package com.small.saasdriver.view.dialog;
...
public class ItemDialog extends Dialog implements OnItemClickListener {
	 ...
	 * 带监听器参数的构造函数
	 */
	public ItemDialog(Context context, String[] items, int requestCode, OnDialogItemClickListener listener) {
		this(context, items, null, requestCode, listener);
	}

	public ItemDialog(Context context, String[] items, String title, int requestCode,
