...
import com.small.saasdriver.utils.CommonUtils;
...
public class DragGrid extends GridView {
	...
	public void init(Context context) {
		...
		// 将布局文件中设置的间距dip转为px
		mHorizontalSpacing = CommonUtils.Dp2Px(context, mHorizontalSpacing);
	}
	...
	public void setOnItemClickListener(final MotionEvent ev) {
		setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
				...
				// return false;
				// }
				TextView dragTextView = (TextView) getChildAt(dragPosition - getFirstVisiblePosition());
					...
					moveAnimation.setAnimationListener(new AnimationListener() {
						...
						public void onAnimationEnd(Animation animation) {
							...
							if (animation.toString().equalsIgnoreCase(LastAnimationID)) {
								...
								if (exchangelis != null) {
									exchangelis.exchange(startPosition, dropPosition);
								}
