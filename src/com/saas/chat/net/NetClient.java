...
import com.saas.chat.common.NetUtil;
...
public class NetClient {
	...
	// Imageload缓存目录
	private static File cacheDir = new File(MyApplication.getHJYCacheDir() + "/Imageload");
	...
	static {
		ActivityManager am = (ActivityManager) MyApplication.getmContext()
				.getSystemService(Context.ACTIVITY_SERVICE);
		int memClass = am.getMemoryClass();
		int cacheSize = 1024 * 1024 * memClass / 4; // 硬引用缓存容量，为系统可用内存的1/4

		binner_options = new DisplayImageOptions.Builder()
				.showImageOnLoading(R.drawable.em_large_logo_default_4) // resource
				// or
				.showImageForEmptyUri(R.drawable.em_large_logo_default_4) // resource
				.showImageOnFail(R.drawable.em_large_logo_default_4) // resource or
		...
		icon_options = new DisplayImageOptions.Builder()
				.showImageOnLoading(R.drawable.em_head) // resource
														// or
				.showImageForEmptyUri(R.drawable.em_head) // resource
				.showImageOnFail(R.drawable.em_head) // resource or
		...
		user_icon_options = new DisplayImageOptions.Builder()
				.showImageOnLoading(R.drawable.em_head) // resource
				.showImageForEmptyUri(R.drawable.em_head) // resource
				.showImageOnFail(R.drawable.em_head) // resource
				.cacheInMemory(true) // default
				.cacheOnDisc(true) // default
		...
		ImageLoaderConfiguration config = new ImageLoaderConfiguration.Builder(
				MyApplication.getmContext()).threadPoolSize(10)
