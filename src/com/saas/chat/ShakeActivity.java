...
import com.saas.chat.common.ShakeListener;
import com.saas.chat.common.ShakeListener.OnShakeListener;
...
public class ShakeActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.em_activity_shake);
		...
		{	public void onDrawerOpened()
			{	
				mDrawerBtn.setBackground(getResources().getDrawable(R.drawable.em_shake_report_dragger_down));
		...
		{	public void onDrawerClosed()
			{	
				mDrawerBtn.setBackground(getResources().getDrawable(R.drawable.em_shake_report_dragger_up));
