...
import com.saas.chat.view.activity.GroupListActivity;
import com.saas.chat.view.activity.NewFriendsListActivity;
import com.saas.chat.view.activity.PublishUserListActivity;
import com.saas.chat.view.activity.SearchActivity;
...
public class Fragment_Friends extends Fragment implements OnClickListener,
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (layout == null) {
			...
			layout = ctx.getLayoutInflater().inflate(R.layout.em_fragment_friends,
					null);
	...
	private void initViews() {
		...
		layout_head = ctx.getLayoutInflater().inflate(
				R.layout.em_layout_head_friend, null);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		if (user != null) {
			...
			getActivity().overridePendingTransition(R.anim.em_push_left_in,
