...
import com.saas.chat.ShakeActivity;
import com.saas.chat.common.Utils;
import com.saas.chat.view.activity.AlbumActivity;
import com.saas.chat.view.activity.LoginActivity;
...
public class Fragment_Dicover extends Fragment implements OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (layout == null) {
			...
			layout = ctx.getLayoutInflater().inflate(R.layout.em_fragment_dicover,
					null);
			initViews();
			initData();
			setOnListener();
