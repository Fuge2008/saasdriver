...
import com.saas.chat.adpter.NewMsgAdpter;
...
import com.saas.chat.view.activity.PublishMsgListActivity;
...
public class Fragment_Msg extends Fragment implements OnClickListener,
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (layout == null) {
			...
			layout = ctx.getLayoutInflater().inflate(R.layout.em_fragment_msg,
					null);
