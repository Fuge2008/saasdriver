...
import com.saas.chat.common.DES;
	...
	private void getRegister() {
		...
		netClient.post(Constants.RegistURL, params, new BaseJsonRes() {
			...
			public void onMySuccess(String data) {
				...
				Utils.putValue(RegisterActivity.this, Constants.PWD,pwd);
					...
					public void onSuccess() {
						runOnUiThread(new Runnable() {
							public void run() {
								...
								overridePendingTransition(R.anim.em_push_up_in,
										R.anim.em_push_up_out);
								finish();
							}
						});
					}
				...
				new JsonHttpResponseHandler() {
					...
					public void onSuccess(JSONObject response) {
						...
						try {
							...
							if (result == null) {
								Utils.showLongToast(MyApplication.getmContext(),
										Constants.NET_ERROR);
			...
			if (phone.length() == 11) {
				if (Utils.isMobileNO(phone)) {
					btn_send.setBackground(getResources().getDrawable(
							R.drawable.em_btn_bg_green));
					btn_send.setTextColor(0xFFFFFFFF);
					btn_send.setEnabled(true);
					btn_register.setBackground(getResources()
							.getDrawable(R.drawable.em_btn_bg_green));
				...
				btn_send.setBackground(getResources().getDrawable(
						R.drawable.em_btn_enable_green));
				btn_send.setTextColor(0xFFD0EFC6);
				btn_send.setEnabled(false);
				btn_register.setBackground(getResources().getDrawable(
						R.drawable.em_btn_enable_green));
