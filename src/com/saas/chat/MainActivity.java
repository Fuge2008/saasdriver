...
import com.saas.chat.bean.InviteMessage;
import com.saas.chat.bean.User;
import com.saas.chat.bean.InviteMessage.InviteMesageStatus;
import com.saas.chat.chat.ChatActivity;
import com.saas.chat.common.Utils;
import com.saas.chat.dialog.WarnTipDialog;
import com.saas.chat.dialog.TitleMenu.ActionItem;
import com.saas.chat.dialog.TitleMenu.TitlePopup;
import com.saas.chat.dialog.TitleMenu.TitlePopup.OnItemOnClickListener;
import com.saas.chat.view.UpdateService;
import com.saas.chat.view.activity.AddGroupChatActivity;
import com.saas.chat.view.activity.GetMoneyActivity;
import com.saas.chat.view.activity.PublicActivity;
import com.saas.chat.view.fragment.Fragment_Dicover;
import com.saas.chat.view.fragment.Fragment_Friends;
import com.saas.chat.view.fragment.Fragment_Msg;
import com.saas.chat.view.fragment.Fragment_Profile;
import com.saas.chat.zxing.CaptureActivity;
...
//		textviews = new TextView[2];
		...
		getSupportFragmentManager().beginTransaction().add(R.id.fragment_container, homefragment)
				.add(R.id.fragment_container, contactlistfragment).add(R.id.fragment_container, profilefragment)
				.add(R.id.fragment_container, findfragment).hide(contactlistfragment).hide(profilefragment)
				.hide(findfragment).show(homefragment).commit();
		updateUnreadLabel();
//		getSupportFragmentManager().beginTransaction().add(R.id.fragment_container, homefragment)
//		.add(R.id.fragment_container, contactlistfragment).hide(contactlistfragment).show(homefragment).commit();
//		updateUnreadLabel();
	}
	...
	public void onTabClicked(View view) {
		...
		case R.id.re_contact_list:
			...
			img_right.setVisibility(View.VISIBLE);
			img_right.setImageResource(R.drawable.em_icon_titleaddfriend);
			break;
		case R.id.re_find:
			index = 2;
	...
	private void initPopWindow() {
		...
		// 给标题栏弹窗添加子类
		titlePopup.addAction(new ActionItem(this, R.string.menu_groupchat, R.drawable.em_icon_menu_group));
		titlePopup.addAction(new ActionItem(this, R.string.menu_addfriend, R.drawable.em_icon_menu_addfriend));
		titlePopup.addAction(new ActionItem(this, R.string.menu_qrcode, R.drawable.em_icon_menu_sao));
		titlePopup.addAction(new ActionItem(this, R.string.menu_money, R.drawable.em_abv));
	}
	...
	// finish();
	// overridePendingTransition(R.anim.em_push_up_in, R.anim.em_push_up_out);
	// break;
	// }
	// return true;
	// }
	...
	private void initVersion() {
		...
		if (!TextUtils.isEmpty(versionInfo)) {
			Tipdialog = new WarnTipDialog(this, "发现新版本：  1、更新啊阿三达到阿德阿   2、斯顿阿斯顿撒旦？");
	...
	private void initReceiver() {
		...
		startService(intent);
		registerReceiver(new MyBroadcastReceiver(), new IntentFilter("com.saas.chat.Brodcast"));
