...
import com.saas.chat.chat.task.LoadLocalBigImgTask;
import com.saas.chat.chat.utils.ImageCache;
import com.saas.chat.widght.TouchImageView.TouchImageView;
...
public class ShowBigImage extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		default_res = getIntent().getIntExtra("default_image", R.drawable.em_head);
